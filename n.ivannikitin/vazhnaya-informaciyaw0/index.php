    ...
    <div class="important_page">
        ...
        <div class="columns columns_padding">
            ...
            <div class="columns__item">
                ...
                <p>Для входа на мастер-класс, нажмите кнопку ниже.<br />
                    Также, ссылка для входа на эфир будет отправлена вам на e-mail.</p>
        ...
        <div class="grey-block">
            ...
            <div class="go-to-onair">
                <a href="/onair3dbiz/?<?=$_SERVER['QUERY_STRING']?>" class="button green no-shadow no-border">Войти на мастер-класс</a>
            </div>

            <div class="phone-sub">
                <div class="phone-sub__title">Оставьте Ваш номер телефона, и мы отправим Вам<br />
                    одно смс напоминание за полчаса до начала трансляции</div>
                <div class="phone-sub__form send-phone-form">
                    <input type="hidden" class="send-today-field" value="1">
