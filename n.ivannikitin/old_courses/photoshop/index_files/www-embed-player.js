...
a=Rc(a);Kc.test(c)||O("invalid_callback");b=Sc(b);d=d&&d.length?Sc(d):null;return[encodeURIComponent(a.Za).replace(/%2C/g,",").replace(/%2F/g,"/"),"/k=",e(a.version),"/m=",e(b),d?"/exm="+e(d):"","/rt=j/sv=1/d=1/ed=1",a.qa?"/am="+e(a.qa):"",a.ya?"/rs="+e(a.ya):"",a.Ba?"/t="+e(a.Ba):"","/cb=",e(c)].join("")}
...
"k",!0);d=Tc(a,"am");e=Tc(a,"rs");a=Tc(a,"t");return{Za:b,version:c,qa:d,ya:e,Ba:a}}
...
function ed(a,b,c){function d(a,b){if(E)return 0;kc.clearTimeout(y);Z.push.apply(Z,G);var d=((rc||{}).config||{}).update;d?d(f):f&&L(N,"cu",[]).push(f);if(b){Dc("me0",a,ta);try{bd(b,c,m)}finally{Dc("me1",a,ta)}}return 1}
...
if(!a)return 0;Dc("ml1",G,ta);0<fa&&ea[fa-1]?ea[fa]=function(){c(b)}:c(b)};
if(G.length){var Bc="loaded_"+N.I++;rc[Bc]=function(a){ea[fa](a);rc[Bc]=null};
a=Mc(c,G,"gapi."+Bc,k);k.push.apply(k,G);Dc("ml0",G,ta);b.sync||kc.___gapisync?Zc(a):$c(a)}else ea[fa](nc)}else d(G)&&e&&e()}
...
Q.prototype.C=function(a){this.b=0;Ld(this,2,a)};
Q.prototype.F=function(a){this.b=0;Ld(this,3,a)};
function Ld(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.C,g=a.F;if(e instanceof Q)Wd(e,Od(f||t,g||null,a)),d=!0;else{var h;if(e)try{h=!!e.$goog_Thenable}catch(m){h=!1}else h=!1;if(h)e.then(f,g,a),d=!0;else{if(qa(e))try{var k=e.then;if(pa(k)){Yd(e,k,f,g,a);d=!0;break a}}catch(m){g.call(a,m);d=!0;break a}d=!1}}}d||(a.w=c,a.b=b,a.g=null,Xd(a),3!=b||c instanceof Sd||Zd(a,c))}}
function Yd(a,b,c,d,e){function f(a){h||(h=!0,d.call(e,a))}
function g(a){h||(h=!0,c.call(e,a))}
var h=!1;try{b.call(a,g,f)}catch(k){f(k)}}
function Xd(a){a.l||(a.l=!0,nd(a.B,a))}
function Ud(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.i=null);return b}
Q.prototype.B=function(){for(var a;a=Ud(this);)Vd(this,a,this.b,this.w);this.l=!1};
...
function be(a,b,c,d){if(b=a.g[b]){var e=a.b;(b=Da(b,function(a){return e[a+1]==c&&e[a+2]==d}))&&a.J(b)}}
l.J=function(a){var b=this.b[a];if(b){var c=this.g[b];0!=this.j?(this.i.push(a),this.b[a+1]=t):(c&&Ea(c,a),delete this.b[a],delete this.b[a+1],delete this.b[a+2])}return!!b};
l.V=function(a,b){var c=this.g[a];if(c){for(var d=Array(arguments.length-1),e=1,f=arguments.length;e<f;e++)d[e-1]=arguments[e];if(this.w)for(e=0;e<c.length;e++){var g=c[e];ce(this.b[g+1],this.b[g+2],d)}else{this.j++;try{for(e=0,f=c.length;e<f;e++)g=c[e],this.b[g+1].apply(this.b[g+2],d)}finally{if(this.j--,0<this.i.length&&0==this.j)for(;c=this.i.pop();)this.J(c)}}return 0!=e}return!1};
function ce(a,b,c){nd(function(){a.apply(b,c)})}
l.clear=function(a){if(a){var b=this.g[a];b&&(C(b,this.J,this),delete this.g[a])}else this.b.length=0,this.g={}};
...
;var xe=r("yt.pubsub.pubsub.instance_")||r("yt.pubsub.instance_")||new R;R.prototype.subscribe=R.prototype.subscribe;R.prototype.unsubscribeByKey=R.prototype.J;R.prototype.publish=R.prototype.V;R.prototype.clear=R.prototype.clear;q("yt.pubsub.instance_",xe,void 0);q("yt.pubsub.pubsub.instance_",xe,void 0);var ye=r("yt.pubsub.pubsub.subscribedKeys_")||r("yt.pubsub.subscribedKeys_")||{};q("yt.pubsub.subscribedKeys_",ye,void 0);q("yt.pubsub.pubsub.subscribedKeys_",ye,void 0);
var ze=r("yt.pubsub.pubsub.topicToKeys_")||r("yt.pubsub.topicToKeys_")||{};q("yt.pubsub.topicToKeys_",ze,void 0);q("yt.pubsub.pubsub.topicToKeys_",ze,void 0);var Ae=r("yt.pubsub.pubsub.isSynchronous_")||r("yt.pubsub.isSynchronous_")||{};q("yt.pubsub.isSynchronous_",Ae,void 0);q("yt.pubsub.pubsub.isSynchronous_",Ae,void 0);function Be(){return r("yt.pubsub.pubsub.instance_")||r("yt.pubsub.instance_")}
function Ce(a){ze[a]&&(a=ze[a],C(a,function(a){ye[a]&&delete ye[a]}),a.length=0)}
function De(a){var b=Be();if(b)if(b.clear(a),a)Ce(a);else for(var c in ze)Ce(c)}
function Ee(a,b){var c=Be();return c?c.publish.apply(c,arguments):!1}
function Fe(a,b){var c=Be();if(c){var d=c.subscribe(a,function(){var c=arguments,f;f=function(){ye[d]&&b.apply(window,c)};
try{Ae[a]?f():V(f,0)}catch(g){U(g)}},void 0);
ye[d]=!0;ze[a]||(ze[a]=[]);ze[a].push(d);return d}return 0}
function Ge(a){var b=Be();b&&("number"==typeof a?a=[a]:u(a)&&(a=[parseInt(a,10)]),C(a,function(a){b.unsubscribeByKey(a);delete ye[a]}))}
;var He=/\.vflset|-vfl[a-zA-Z0-9_+=-]+/,Ie=/-[a-zA-Z]{2,3}_[a-zA-Z]{2,3}(?=(\/|$))/;function Je(a,b){var c=Ke(a),d=document.getElementById(c),e=d&&ue(d,"loaded"),f=d&&!e;if(e)b&&b();else{if(b){var e=Fe(c,b),g=""+ra(b);Le[g]=e}f||(d=Me(a,c,function(){ue(d,"loaded")||(ve(d),Ee(c),V(w(De,c),0))}))}}
...
function Ne(a,b){if(a&&b){var c=""+ra(b);(c=Le[c])&&Ge(c)}}
...
function af(a,b){var c=T("XSRF_FIELD_NAME",void 0),d;b.headers&&(d=b.headers["Content-Type"]);return!b.rb&&(!Wb(K(a)[3]||null)||b.withCredentials||Wb(K(a)[3]||null)==document.location.hostname)&&"POST"==b.method&&(!d||"application/x-www-form-urlencoded"==d)&&!(b.D&&b.D[c])}
function bf(a,b){var c=b.format||"JSON";b.Ka&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var d=T("XSRF_FIELD_NAME",void 0),e=T("XSRF_TOKEN",void 0),f=b.kb;f&&(f[d]&&delete f[d],a=Xe(a,f||{}));var g=b.postBody||"",f=b.D;af(a,b)&&(f||(f={}),f[d]=e);f&&u(g)&&(d=We(g),bb(d,f),g=b.wa&&"JSON"==b.wa?JSON.stringify(d):Ye(d));var h=!1,k,m=cf(a,function(a){if(!h){h=!0;k&&window.clearTimeout(k);var d=Ve(a),e=null;if(d||400<=a.status&&
500>a.status)e=df(c,a,b.qb);if(d)a:if(204==a.status)d=!0;else{switch(c){case "XML":d=0==parseInt(e&&e.return_code,10);break a;case "RAW":d=!0;break a}d=!!e}var e=e||{},f=b.context||n;d?b.N&&b.N.call(f,a,e):b.onError&&b.onError.call(f,a,e);b.Qa&&b.Qa.call(f,a,e)}},b.method,g,b.headers,b.responseType,b.withCredentials);
...
function Lf(a){var b=Mf(a),c=document.getElementById(b),d=c&&ue(c,"loaded");d||c&&!d||(c=Nf(a,b,function(){ue(c,"loaded")||(ve(c),Ee(b),V(w(De,b),0))}))}
...
;var Of={"api.invalidparam":2,auth:150,"drm.auth":150,"heartbeat.net":150,"heartbeat.servererror":150,"heartbeat.stop":150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};var Pf;var Qf=D,Qf=Qf.toLowerCase();if(-1!=Qf.indexOf("android")){var Rf=Qf.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/);if(Rf)Pf=Number(Rf[1]);else{var Sf={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1,kitkat:4.4,lollipop:5.1,marshmallow:6,nougat:7.1},Tf=[],Uf=0,Vf;for(Vf in Sf)Tf[Uf++]=Vf;var Wf=Qf.match("("+Tf.join("|")+")");Pf=Wf?Sf[Wf[0]]:0}}else Pf=void 0;var Xf=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],Yf=['audio/mp4; codecs="mp4a.40.2"'];var Zf;var $f=D,ag=$f.match(/\((iPad|iPhone|iPod)( Simulator)?;/);if(!ag||2>ag.length)Zf=void 0;else{var bg=$f.match(/\((iPad|iPhone|iPod)( Simulator)?; (U; )?CPU (iPhone )?OS (\d+_\d)[_ ]/);Zf=bg&&6==bg.length?Number(bg[5].replace("_",".")):0}0<=Zf&&0<=D.search("Safari")&&D.search("Version");function cg(a){P.call(this);this.b=[];this.g=a||this}
...
;function rg(){if(null==r("_lact",window)){var a=parseInt(T("LACT"),10),a=isFinite(a)?x()-Math.max(a,0):-1;q("_lact",a,window);-1==a&&sg();Ff(document,"keydown",sg);Ff(document,"keyup",sg);Ff(document,"mousedown",sg);Ff(document,"mouseup",sg);Fe("page-mouse",sg);Fe("page-scroll",sg);Fe("page-resize",sg)}}
function sg(){null==r("_lact",window)&&(rg(),r("_lact",window));var a=x();q("_lact",a,window);Ee("USER_ACTIVE")}
...
"SAPISID":"APISID")),d)){var e=e?"SAPISIDHASH":"APISIDHASH",f=String(n.location.href);c=f&&d&&e?[e,wc(jc(f),d,c||null)].join(" "):null;break a}c=null}c&&(b.headers.Authorization=c,b.headers["X-Goog-AuthUser"]=T("SESSION_INDEX",0));c=this.b.nb;c.startsWith("http")||(c="//"+c);W("youtubei_for_web")&&(c="");(d=this.b.Oa)&&(c=d);hf(""+c+("/youtubei/"+this.b.innertubeApiVersion+"/"+a)+"?alt=json&key="+this.b.innertubeApiKey,b)};var yg=r("yt.logging.latency.usageStats_")||{};q("yt.logging.latency.usageStats_",yg,void 0);var zg=0;function Ag(a){yg[a]=yg[a]||{count:0};var b=yg[a];b.count++;b.time=oe();zg||(zg=of(Bg,0));return 10<b.count?(11==b.count&&jf(Error("CSI data exceeded logging limit with key: "+a)),!0):!1}
...
;function rh(a,b){P.call(this);this.w=this.l=a;this.T=b;this.C=!1;this.g={};this.Z=this.S=null;this.U=new R;yd(this,w(zd,this.U));this.j={};this.K=this.aa=this.i=this.ha=this.b=null;this.W=!1;this.L=this.B=this.H=this.R=null;this.ba={};this.Ca=["onReady"];this.X=new cg(this);yd(this,w(zd,this.X));this.fa=null;this.oa=NaN;this.Y={};sh(this);this.G("onDetailedError",v(this.Ta,this));this.G("onTabOrderChange",v(this.Ea,this));this.G("onTabAnnounce",v(this.pa,this));this.G("WATCH_LATER_VIDEO_ADDED",v(this.Ua,
this));this.G("WATCH_LATER_VIDEO_REMOVED",v(this.Va,this));wb||(this.G("onMouseWheelCapture",v(this.Ra,this)),this.G("onMouseWheelRelease",v(this.Sa,this)));this.G("onAdAnnounce",v(this.pa,this));this.M=new cg(this);yd(this,w(zd,this.M));this.ga=!1;this.ea=null}
z(rh,P);var th=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];l=rh.prototype;l.na=function(a,b){this.f||(uh(this,a),vh(this,b),this.C&&wh(this))};
...
function zh(a,b){if((!b||(5!=(Of[b.errorCode]||5)?0:-1!=th.indexOf(b.errorCode)))&&yh(a)){var c=Ah(a);c&&c.stopVideo&&c.stopVideo();var d=a.b;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=xf(c));d.args.autoplay=1;d.args.html5_unavailable="1";uh(a,d);vh(a,"flash")}}
function vh(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&yh(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==Pf)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?Xf:Yf,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=Bh(a)||a.b.assets.js);
a.b.disable.html5=!d;d||(a.b.args.html5_unavailable="1")}c=!!a.b.disable.html5}b=c?yh(a)?"flash":"unsupported":"html5"}("flash"==b?a.lb:a.mb).call(a)}}
function Bh(a){var b=!0,c=Ah(a);c&&a.b&&(a=a.b,b=ue(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
l.mb=function(){if(!this.W){var a=Bh(this);if(a&&"html5"==Ch(this))this.K="html5",this.C||this.P();else if(Dh(this),this.K="html5",a&&this.H)this.l.appendChild(this.H),this.P();else{this.b.loaded=!0;var b=!1;this.R=v(function(){b=!0;var a=this.l,d=yf(this.b);r("yt.player.Application.create")(a,d);this.P()},this);
this.W=!0;a?this.R():(Oe(this.b.assets.js,this.R),Kf(this.b.assets.css),Eh(this)&&!b&&q("yt.player.Application.create",null,void 0))}}};
l.lb=function(){var a=yf(this.b);if(!this.B){var b=Ah(this);b&&(this.B=document.createElement("SPAN"),this.B.tabIndex=0,dg(this.X,this.B,"focus",this.ta),this.L=document.createElement("SPAN"),this.L.tabIndex=0,dg(this.X,this.L,"focus",this.ta),b.parentNode&&b.parentNode.insertBefore(this.B,b),b.parentNode&&b.parentNode.insertBefore(this.L,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==Ch(this))this.K="flash",this.C||this.P();else{Dh(this);this.K=
...
l.P=function(){if(!this.f){var a=Ah(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.W=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))zh(this);else{sh(this);this.C=!0;a=Ah(this);a.addEventListener&&(this.S=Fh(this,a,"addEventListener"));a.removeEventListener&&(this.Z=Fh(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.g[d]||(this.g[d]=Fh(this,a,d))}for(var e in this.j)this.S(e,
...
Za(a.Y,String(d))};
return c}
l.Ea=function(a){a=a?Qb:Pb;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.B||b==this.L||(b.focus(),b!=document.activeElement));)b=a(b)};
l.pa=function(a){Ee("a11y-announce",a)};
l.Ta=function(a){zh(this,a)};
l.Ua=function(a){Ee("WATCH_LATER_VIDEO_ADDED",a)};
l.Va=function(a){Ee("WATCH_LATER_VIDEO_REMOVED",a)};
l.Ra=function(){if(!this.ga){if(Ab){var a=document,b=a.scrollingElement?a.scrollingElement:hb||"CSS1Compat"!=a.compatMode?a.body||a.documentElement:a.documentElement,a=a.parentWindow||a.defaultView;this.ea=I&&J("10")&&a.pageYOffset!=b.scrollTop?new Ha(b.scrollLeft,b.scrollTop):new Ha(a.pageXOffset||b.scrollLeft,a.pageYOffset||b.scrollTop);dg(this.M,window,"scroll",this.Ya);dg(this.M,this.l,"touchmove",this.Xa)}else dg(this.M,this.l,"mousewheel",this.ua),dg(this.M,this.l,"wheel",this.ua);this.ga=!0}};
l.Sa=function(){eg(this.M);this.ga=!1};
...
l.Ja=function(){return this.K||Ch(this)};
l.Ia=function(){return this.fa};
function Ch(a){return(a=Ah(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function Dh(a){fh("dcp");a.cancel();sh(a);a.K=null;a.b&&(a.b.loaded=!1);var b=Ah(a);"html5"==Ch(a)?Bh(a)||!Eh(a)?a.H=b:(b&&b.destroy&&b.destroy(),a.H=null):b&&b.destroy&&b.destroy();for(var b=a.l,c;c=b.firstChild;)b.removeChild(c);eg(a.X);a.B=null;a.L=null}
...
;var Hh={},Ih="player_uid_"+(1E9*Math.random()>>>0);function Jh(a,b){a=u(a)?Ob(a):a;b=xf(b);var c=Ih+"_"+ra(a),d=Hh[c];if(d)return d.na(b),d.g;d=new rh(a,c);Hh[c]=d;Ee("player-added",d.g);yd(d,w(Kh,d));V(function(){d.na(b)},0);
return d.g}
...
l.eb=function(a,b){this.j&&!this.f&&gi(this.g,a,this.ia(a,b))};
...
ki.prototype.o=function(){ki.A.o.call(this);delete this.b};function li(a,b,c,d){P.call(this);this.g=b||null;this.B="*";this.i=c||null;this.sessionId=null;this.channel=d||null;this.H=!!a;this.w=v(this.C,this);window.addEventListener("message",this.w)}
aa(li,P);
li.prototype.C=function(a){if(!("*"!=this.i&&a.origin!=this.i||this.g&&a.source!=this.g)&&u(a.data)){var b;try{b=Cd(a.data)}catch(c){return}if(!(null==b||this.H&&(this.sessionId&&this.sessionId!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin?this.i=this.B=a.origin:U(Error("MessageEvent origin is null"),"WARNING");this.g=a.source;this.sessionId=b.id;this.b&&(this.b(),this.b=null);break;case "command":this.j&&(this.l&&!(0<=Ba(this.l,b.func))||this.j(b.func,
b.args))}}};
li.prototype.sendMessage=function(a,b){var c=b||this.g;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=Ed(a);c.postMessage(d,this.B)}catch(e){U(e,"WARNING")}}};
li.prototype.o=function(){window.removeEventListener("message",this.w);P.prototype.o.call(this)};function mi(a,b,c){li.call(this,a,b,c||T("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.l=this.b=this.j=null}
aa(mi,li);function ni(){var a=!!T("WIDGET_ID_ENFORCE"),a=this.f=new mi(a),b=v(this.ab,this);a.j=b;a.l=null;this.f.channel="widget";if(a=T("WIDGET_ID"))this.f.sessionId=a;this.i=[];this.l=!1;this.j={}}
l=ni.prototype;l.ab=function(a,b){if("addEventListener"==a&&b){var c=b[0];this.j[c]||"onReady"==c||(this.addEventListener(c,oi(this,c)),this.j[c]=!0)}else this.Aa(a,b)};
l.Aa=function(){};
...
l.fb=function(a){pi(this,{playbackQuality:a})};
l.gb=function(a){pi(this,{playbackRate:a})};
...
l.jb=function(){pi(this,{muted:this.b.isMuted(),volume:this.b.getVolume()})};
l.ib=function(a){a={currentTime:a,videoBytesLoaded:this.b.getVideoBytesLoaded(),videoLoadedFraction:this.b.getVideoLoadedFraction(),currentTimeLastUpdated_:x()/1E3,playbackRate:this.b.getPlaybackRate(),mediaReferenceTime:this.b.getMediaReferenceTime()};this.b.getProgressState&&(a.progressState=this.b.getProgressState());pi(this,a)};
...
ri.prototype.J=function(a){return this.f?!1:this.b.J(a)};
...
aa(wi,B);function xi(a){B.call(this,a.message||a.description||a.name);this.Pa=a instanceof yi;this.b=a instanceof Sd}
...
for(var ta in d)b[ta]=d[ta]}b.bsq=Ji++;hf("//www.youtube.com/ad_data_204",{Ka:!1,D:b})}
...
Ki.prototype.clear=function(){Y={}};q("yt.pubsub.publish",Ee,void 0);var Oi=null,Pi=null,Qi=null,Ri={};function Si(a){ug(a.payload_name,a.payload,W("enable_youtubei_innertube")?xg:Wh,void 0,void 0)}
